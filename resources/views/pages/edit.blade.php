				...
				<div class="well well-sm">
					...
					<div class="row">
						<div class="col-md-12 col-lg-12">
							...
							<form action="{{ route('pages.update', encrypt($page->id)) }}" class="smart-form" method="post">
										...
										<section class="col col-8">
											<div class="row">
												<section class="col col-10 flexibled-error">
													...
													<label class="input">
														<input type="text" name="title" value="{{ old('title') ? old('title') : $page->title }}" class="input-sm border-0 border-bottom-1 font-bold font-18">
													</label>
												</section>
											</div>
											<div class="row">
												<section class="col col-10 flexibled-error atoslug-upper">
													...
													<label class="input">
														<input type="text" name="slug" value="{{ old('slug') ? old('slug') :$page->slug }}" class="input-sm border-0 border-bottom-1 font-15">
													</label>
													<div class="note">
												...
												<section class="col col-10">
													...
													<label class="textarea">
														<textarea name="excerpt" rows="3" data-height="75" data-menubar="false" data-ignore="image"
															id="excerpt" class="custom-scroll tinymce border-0 border-bottom-1">{{ old('excerpt') ? old('excerpt') :$page->excerpt }}</textarea>
													</label>
												</section>
											</div>
											<div class="row">
												<section class="col col-10 flexibled-error">
													...
													<label class="textarea">
														<textarea name="description" rows="7"
															id="description" class="custom-scroll tinymce border-0 border-bottom-1">{{ old('description') ? old('description') :$page->description }}</textarea>
													</label>
												</section>
											</div>
										</section>
													...
													<label class="select">
														<select class="input-sm border-0 border-bottom-1" name="language_id">
															...
															@foreach($languages as $language)
																...
																@if(old('language_id') ==$language->id || !old('language_id') && $page->language_id ==$language->id)
													...
													<label class="select">
														<select class="input-sm border-0 border-bottom-1" name="translate_of">
															...
															@foreach($ofpages as $ofpage)
																...
																@if(old('translate_of') ==$ofpage->id || !old('translate_of') && $page->translate_of == $ofpage->id)
