				...
				<div class="well well-sm">
					...
					<div class="row">
						<div class="col-md-12 col-lg-12">
							...
							<form action="{{ route('posts.index') }}" class="smart-form" method="post">
											...
											<div class="row">
												<section class="col col-10 flexibled-error">
													...
													<label class="select select-multiple">
														<select class="custom-scroll border-0 border-bottom-1" name="categories[]" multiple="">

															@foreach($categories as $category)

																@if(old('categories') ==$category->term_id)
