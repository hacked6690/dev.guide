				...
				<div class="well well-sm">
					...
					<div class="row">
						<div class="col-md-12 col-lg-8">
							...
							<form action="{{ route('layout_items.update', encrypt($layout_item->id)) }}" class="smart-form" method="post">
								...
								<fieldset>
											...
											<label class="select">
												<select class="input-sm border-0 border-bottom-1" name="category_id">
													...
													@foreach($layout_categories as $layout_category)
														...
														@if($layout_item->category_id ==$layout_category->id)
									...
									<div class="row">
										<section class="col col-6 flexibled-error">
											...
											<label class="input">
												<input type="text" name="slug" value="{{ old('slug') ? old('slug') :$layout_item->slug }}" class="input-sm border-0 border-bottom-1">
											</label>
											<div class="note">
									...
									<div class="row">
										<section class="col col-6 flexibled-error">
											...
											<label class="input">
												<input type="text" name="title" value="{{ old('title') ? old('title') :$layout_item->title }}" class="input-sm border-0 border-bottom-1">
											</label>
										</section>
									</div>
									<div class="row">
										<section class="col col-6 flexibled-error">
											...
											<label class="input"> <i class="icon-append glyphicon glyphicon-link"></i>
												<input type="text" name="url" value="{{ old('url') ? old('url') :$layout_item->url }}" class="input-sm border-0 border-bottom-1">
											</label>
										</section>
									</div>
									<div class="row">
										<section class="col col-6 flexibled-error">
											...
											<label class="input">
												<input type="text" name="icon" value="{{ old('icon') ? old('icon') :$layout_item->icon }}" class="input-sm border-0 border-bottom-1">
											</label>
										</section>
									</div>
									<div class="row">
										<section class="col col-6 flexibled-error">
											...
											<label class="input">
												<input type="text" name="ordered" value="{{ old('ordered') ? old('ordered') :$layout_item->ordered }}" class="input-sm border-0 border-bottom-1">
											</label>
										</section>
									</div>
									<div class="row">
										<section class="col col-6">
											...
											<label class="textarea">
												<textarea name="description" rows="3"
													class="custom-scroll border-0 border-bottom-1">{{ old('description') ? old('description') :$layout_item->description }}</textarea>
											</label>
										</section>
									</div>
									<div class="row">
										<section class="col col-6">
											...
											<label class="input">
												<input type="text" name="options" value="{{ old('options') ? old('options') :$layout_item->options }}" class="input-sm border-0 border-bottom-1">
											</label>
											<div class="note">
											...
											<label class="select">
												<select class="input-sm border-0 border-bottom-1" name="parent">
													...
													@foreach($parents as $parent)
														...
														@if($layout_item->parent ==$parent->id)
