	...
	<div id="content">
		...
		<div class="row">
			<form action="{{ route('guideprice.index') }}" class="smart-form" method="post">
							{{csrf_field()}}
								<fieldset>
								<input type="hidden" name="guide_id" value="{{encrypt($guide_id)}}"/>
									<div class="row">
									      	...
									      	<tr>
										        ...
										        <td>
										        	<div class="btn-action">
											        	...
											        	<a target="_blank" href="{{ route('guideprice.edit', Helper::encodeString($guideprice->id,Helper::encryptKey())) }}" class="btn btn-primary btn-xs">edit</a>
