		...
		<div class="slider-inner">
			<div id="da-slider" class="da-slider">
				<div class="da-slide">
					...
					<div class="da-img"><img class="img-responsive" src="{{asset('assets/frontend/plugins/parallax-slider/img/1.png')}}" alt=""></div>
				</div>
				<div class="da-slide">
				...
				<div class="da-slide">
					...
					<p><i>Lorem ipsum dolor amet</i> <br /> <i>tempor incididunt ut</i> <br /> <i>veniam omnis </i></p>
					<div class="da-img"><img src="{{ asset('assets/frontend/plugins/parallax-slider/img/html5andcss3.png')}}" alt="image01" /></div>
				</div>
				<div class="da-arrows">
		...
		<div class="container content-sm">
			...
			<div class="row margin-bottom-20">
					...
					<div class="thumbnails thumbnail-style thumbnail-kenburn">
						<div class="thumbnail-img">
							<div class="overflow-hidden">
								<img class="img-responsive" src="{{asset('assets/frontend/img/main/img1.jpg')}}" alt="">
							</div>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnails thumbnail-style thumbnail-kenburn">
						<div class="thumbnail-img">
							<div class="overflow-hidden">
								<img class="img-responsive" src="{{asset('assets/frontend/img/main/img12.jpg')}}" alt="">
							</div>
							<a class="btn-more hover-effect" href="#">read more +</a>
						</div>
						<div class="caption">
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnails thumbnail-style thumbnail-kenburn">
						<div class="thumbnail-img">
							<div class="overflow-hidden">
								<img class="img-responsive" src="{{asset('assets/frontend/img/main/img3.jpg')}}" alt="">
							</div>
							<a class="btn-more hover-effect" href="#">read more +</a>
						</div>
						<div class="caption">
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnails thumbnail-style thumbnail-kenburn">
						<div class="thumbnail-img">
							<div class="overflow-hidden">
								<img class="img-responsive" src="{{asset('assets/frontend/img/main/img17.jpg')}}" alt="">
							</div>
							<a class="btn-more hover-effect" href="#">read more +</a>
						</div>
						<div class="caption">
			...
			<div class="row margin-bottom-30">
				...
				<div class="col-md-8 md-margin-bottom-40">
					...
					<div class="row">
						<div class="col-sm-4">
							<img class="img-responsive margin-bottom-20" src="{{asset('assets/frontend/img/main/img18.jpg')}}" alt="">
						</div>
						<div class="col-sm-8">
					...
					<div id="myCarousel" class="carousel slide carousel-v1">
						<div class="carousel-inner">
							<div class="item active">
								<img src="{{asset('assets/frontend/img/main/img4.jpg')}}" alt="">
								<div class="carousel-caption">
									<p>Facilisis odio, dapibus ac justo acilisis gestinas.</p>
								</div>
							</div>
							<div class="item">
								<img src="{{asset('assets/frontend/img/main/img2.jpg')}}" alt="">
								<div class="carousel-caption">
									<p>Cras justo odio, dapibus ac facilisis into egestas.</p>
								</div>
							</div>
							<div class="item">
								<img src="{{asset('assets/frontend/img/main/img24.jpg')}}" alt="">
								<div class="carousel-caption">
			...
			<div class="owl-clients-v1">
				<div class="item">
					<img src="{{ asset('assets/frontend/img/clients4/1.png')}}" alt="">
				</div>
				<div class="item">
					<img src="{{ asset('assets/frontend/img/clients4/2.png')}}" alt="">
				</div>
				<div class="item">
					<img src="{{ asset('assets/frontend/img/clients4/3.png')}}" alt="">
				</div>
				<div class="item">
					<img src="{{ asset('assets/frontend/img/clients4/4.png')}}" alt="">
				</div>
				<div class="item">
					<img src="{{ asset('assets/frontend/img/clients4/5.png')}}" alt="">
				</div>
				<div class="item">
					<img src="{{ asset('assets/frontend/img/clients4/6.png')}}" alt="">
				</div>
				<div class="item">
					<img src="{{ asset('assets/frontend/img/clients4/7.png')}}" alt="">
				</div>
				<div class="item">
					<img src="{{ asset('assets/frontend/img/clients4/8.png')}}" alt="">
				</div>
				<div class="item">
					<img src="{{ asset('assets/frontend/img/clients4/9.png')}}" alt="">
				</div>
			</div>
			<!-- End Owl Clients v1 -->
		</div><!--/container-->
