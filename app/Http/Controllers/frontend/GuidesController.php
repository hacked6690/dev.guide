...
class GuidesController extends Controller
{
    ...
    public function index(Request $request)
    {
     ...
     /*   $page = Input::has('page')?intval(Input::get('page')):1;
        ...
        $offset = ($page * $perPage) - $perPage;
        // $users=(array_slice($users->toArray(), $offset, $perPage,true));
    ...
    {
        //
      /* if(!Auth::user()->authorized('guide_create')) {
            abort(403, 'Unauthorized action.');
        }*/
    ...
    public function guide_edit(){
        if(!Auth::user()->authorized('guide_edit')) {
            abort(403, 'Unauthorized action.');
        }
       ...
       $guide_price = GuidePrice::where('guide_id','=',$id)->where('default','=','yes')->first();
        ...
        return view('backend.authorize.edit_guide',compact(['nationalities','provinces','partner_types','genders',
