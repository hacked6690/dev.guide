...
<p>Dear <b style="color:green"><?php echo e($name); ?></b>,</p>
<p>We received a request to confirm your account, pls click the button below to confirm your account ...</p>
<a target="_blank" href="<?php echo e(Helper::VERIFY_LINK()); ?>/<?php echo e(encrypt($id)); ?>" class="btn btn-primary">Confirm Account</a>
<br><br><br>
<hr/>
