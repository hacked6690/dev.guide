					...
					<div class="row">
						<div class="col-md-12 col-lg-12">
									      	...
									      	<tr>
										        ...
										        <td>
										        	<div class="btn-action">
											        	...
											        	<a href="<?php echo e(route('guideprice.edit', Helper::encodeString($guideprice->id,Helper::encryptKey()))); ?>" class="btn btn-primary btn-xs">edit</a>
							...
							<div class="table-footer">
								...
								<?php echo \Helper::paginator(['route' => 'guideprice'], ['items' => $guideprices], ['display' => $display]); ?> 
